...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloudMessenger/GenesysCloudMessenger_version_1.19.0.SNAPSHOT-feature-shared-gradlew-2_commit_4f778f9c3cfd21c9c141e7e43df1d5f95cb9ffc4.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '1.19.0'
  s.dependency 'GenesysCloudMessengerTransport', '2.10.0'
  s.swift_version = '5.0'
