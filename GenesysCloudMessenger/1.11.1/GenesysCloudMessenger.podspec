...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloudMessenger/GenesysCloudMessenger_version_t1.11.1_commit_dda094c15b5b3e621f87b4b72d4bd7e9ad307604.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '1.11.1'
