...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloudMessenger/GenesysCloudMessenger_version_t1.14.1_commit_be016810e340d018fca501b2af00410e4339a120.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '1.14.1'
  s.dependency 'GenesysCloudMessengerTransport', '2.8.5'
  s.swift_version = '5.0'
