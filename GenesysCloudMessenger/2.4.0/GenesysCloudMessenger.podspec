...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://github.com/MyPureCloud/mobile-messenger-ios-sdk/releases/download/v2.4.0/GenesysCloudMessenger.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '2.4.0'
  s.dependency 'GenesysCloudMessengerTransport', '2.14.1'
