...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://github.com/MyPureCloud/mobile-messenger-ios-sdk/releases/download/v2.5.0/GenesysCloudMessenger.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '2.5.0'
  s.dependency 'GenesysCloudMessengerTransport', '2.15.0'
  s.dependency 'GenesysCloudMobileUserTracking', '1.0.0'
