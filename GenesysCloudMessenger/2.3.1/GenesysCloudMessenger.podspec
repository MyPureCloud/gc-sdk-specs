...
GenesysCloudMessenger is an SDK that used as chat handler for GenesysCloud API.
  ...
  s.source = {
  "http" => "https://github.com/MyPureCloud/mobile-messenger-ios-sdk/releases/download/v2.3.1/GenesysCloudMessenger.zip"
  }
  ...
  s.dependency 'GenesysCloudCore', '2.3.1'
  s.dependency 'GenesysCloudMessengerTransport', '2.14.0'
