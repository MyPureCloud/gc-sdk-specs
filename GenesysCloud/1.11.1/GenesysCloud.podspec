...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud_version_t1.11.1_commit_f50546993d7b84fd42ccf0a1fd9f2c6115ba0008.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.11.1'
    sp.dependency 'GenesysCloudMessenger', '1.11.1'
