...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://github.com/MyPureCloud/mobile-messenger-ios-sdk/releases/download/v2.3.1/GenesysCloud.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '2.3.1'
    sp.dependency 'GenesysCloudMessenger', '2.3.1'
