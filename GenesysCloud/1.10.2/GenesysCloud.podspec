...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud_version_t1.10.2_commit_2ac9bca36c9079823357da70ef5d0b4047a5c157.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.10.2'
    sp.dependency 'GenesysCloudMessenger', '1.10.2'
