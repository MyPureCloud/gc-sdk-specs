...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud_version_t1.8.2_commit_cd36499bdd20fef5850e83f6e5e6d28bf1420cce.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudAccessibility', '1.8.2'
    sp.dependency 'GenesysCloudBot', '1.8.2'
    sp.dependency 'GenesysCloudBold', '1.8.2'
    sp.dependency 'GenesysCloudCore', '1.8.2'
    sp.dependency 'GenesysCloudMessenger', '1.8.2'
