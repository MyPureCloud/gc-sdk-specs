...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud_version_t1.10.0_commit_2b755728aac5bb2fd31b9ae9f76313549a4a452b.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.10.0'
    sp.dependency 'GenesysCloudMessenger', '1.10.0'
