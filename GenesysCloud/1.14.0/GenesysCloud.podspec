...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud_version_t1.14.0_commit_b7d51b8d8c06fd12512c1f9c395eb36f91a59d5f.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.14.0'
    sp.dependency 'GenesysCloudMessenger', '1.14.0'
