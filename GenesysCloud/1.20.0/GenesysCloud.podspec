...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://github.com/MyPureCloud/mobile-messenger-ios-sdk/releases/download/v1.20.0/GenesysCloud.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.20.0'
    sp.dependency 'GenesysCloudMessenger', '1.20.0'
