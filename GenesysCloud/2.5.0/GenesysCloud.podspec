...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://github.com/MyPureCloud/mobile-messenger-ios-sdk/releases/download/v2.5.0/GenesysCloud.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '2.5.0'
    sp.dependency 'GenesysCloudMessenger', '2.5.0'
