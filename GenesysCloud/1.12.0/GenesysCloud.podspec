...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud_version_t1.12.0_commit_416c72802aa93444136d4967d7720b71638a10c2.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.12.0'
    sp.dependency 'GenesysCloudMessenger', '1.12.0'
