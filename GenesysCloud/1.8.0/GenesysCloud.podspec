...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud_version_t1.8.0_commit_96a25816c4c911c3d0c9fe277a6154cc4a9b70ca.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudAccessibility', '1.8.0'
    sp.dependency 'GenesysCloudBot', '1.8.0'
    sp.dependency 'GenesysCloudBold', '1.8.0'
    sp.dependency 'GenesysCloudCore', '1.8.0'
    sp.dependency 'GenesysCloudMessenger', '1.8.0'
