...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud_version_t1.16.0_commit_b6ed286113625639ba6d586e34b780560f9455b6.zip"
  }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'GenesysCloudCore', '1.16.0'
    sp.dependency 'GenesysCloudMessenger', '1.16.0'
